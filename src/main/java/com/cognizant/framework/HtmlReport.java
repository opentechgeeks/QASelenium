...
public class HtmlReport implements ReportType {
	...
	public HtmlReport(final ReportSettings reportSettings,
		...
		this.testLogPath = String.valueOf(reportSettings.getReportPath())
				+ "/HTML Results/" + reportSettings.getReportName() + ".html";
		this.resultSummaryPath = String.valueOf(reportSettings.getReportPath())
	...
	public void addTestLogSection(final String section) {
		...
		try {
			final BufferedWriter bufferedWriter = new BufferedWriter(
					new FileWriter(this.testLogPath, true));
			testLogSection = String.valueOf(testLogSection)
	...
	public void updateTestLog(final String stepNumber, final String stepName,
		...
		try {
			...
			if (stepStatus.equals(Status.FAIL)
					|| stepStatus.equals(Status.WARNING)) {
	...
	public void addTestLogFooter(final String executionTime,
			final int nStepsPassed, final int nStepsFailed) {
		try {
			final BufferedWriter bufferedWriter = new BufferedWriter(
					new FileWriter(this.testLogPath, true));
	...
	public void updateResultSummary(final String scenarioName,
		...
		try {
			...
			if (testStatus.equalsIgnoreCase("passed")) {
				testcaseRow = String.valueOf(testcaseRow)
						+ "\t\t\t\t\t <td class='pass'>" + testStatus
						+ "</td> \n" + "\t\t\t\t </tr> \n";
			} else {
				testcaseRow = String.valueOf(testcaseRow)
						+ "\t\t\t\t\t <td class='fail'>" + testStatus
						+ "</td> \n" + "\t\t\t\t </tr> \n";
			}
