 ...
 * {@link nl.fountain.xelem.excel.XLElement XLElements}. A registered
 * ExcelReaderListener listens to events fired by {@link ExcelReader} while the
 * ExcelReader is reading xml-spreadsheets of type spreadsheetML.
 * 
...
public interface ExcelReaderListener {
	...
	/**
	 * Recieve notification of the the construction of a Column. The column is
	 * fully populated, it's column index has been set and can be obtained by
	 ...
	 *            the index of the worksheet (0-based)
	 * @param sheetName
	 *            the name of the worksheet where the cell was found
	 * @param rowIndex
	 *            the index of the row
	 * @param cell
	 *            fully populated instance of Cell
	 */
	 ...
	 */
	void setWorksheetOptions(int sheetIndex, String sheetName,
