...
/**
 * An implementation of the XLElement Pane. Methods of this class are mainly
 * used by {@link nl.fountain.xelem.excel.WorksheetOptions}-methods.
 * 
...
public class XPane extends AbstractXLElement implements Pane {
	...
	public Element assemble(Element parent, GIO gio) {
		...
		if (activeCol > -1)
			pe.appendChild(createElementNS(doc, "ActiveCol", activeCol));
		if (activeRow > -1)
			pe.appendChild(createElementNS(doc, "ActiveRow", activeRow));
		if (rangeSelection != null)
			pe.appendChild(createElementNS(doc, "RangeSelection",
					rangeSelection));
