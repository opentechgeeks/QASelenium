...
public abstract class AbstractXLElement implements XLElement {
	...
	/**
	 * Add a comment to this XLElement. Whether the comment will be printed in
	 * the xml produced during assembly, depends on the setting of the
	 * Workbook's
	 * {@link nl.fountain.xelem.excel.Workbook#setPrintElementComments(boolean)}
	 * -method.
	 * 
	 * @param comment
	 ...
	 * prefix suitable for the calling XLElement-implementation. If comments
	 * were set on the calling XLElement-subclass and comments should be printed
	 * according to the <code>gio</code>, these comments are appended to the
	 * returned element.
	 * 
	 * @param doc
	 *            the enveloping Document
	 * @param gio
	 ...
	 * as it's qualified name. Namespace and prefix of the returned element are
	 * the same as those of the calling AbstractXLElement-subclass.
	 * 
	 * @param doc
	 *            the enveloping Document
	 * @param qName
	...
	/**
	 * Creates an {@link org.w3c.dom.Element} with the given <code>qName</code>
	 * as it's qualified name and the given <code>value</code> appended to it as
	 * a {@link org.w3c.dom.Text}. Namespace and prefix of the returned element
	 * are the same as those of the calling AbstractXLElement-subclass.
	 * 
	 * @param doc
	 *            the enveloping Document.
	 * @param qName
	 ...
	 * it as a {@link org.w3c.dom.Text}. Namespace and prefix of the returned
	 * element are the same as those of the calling AbstractXLElement-subclass.
	 * 
	 * @param doc
	 *            the enveloping Document.
	 * @param qName
	 ...
	 * Namespace and prefix of the returned element are the same as those of the
	...
	/**
	 * Creates an {@link org.w3c.dom.Attr} with the given <code>qName</code> as
	 * it's qualified name and the given value of <code>i</code> as it's value.
	 * Namespace and prefix of the returned attribute are the same as those of
	 * the calling AbstractXLElement-subclass.
	 * 
	 * @param doc
	 *            the enveloping Document.
	 * @param qName
	 *            the qualified name of the newly created attribute.
	 * @param i
	...
	/**
	 * Creates an {@link org.w3c.dom.Attr} with the given <code>qName</code> as
	 * it's qualified name and the given <code>value</code> as it's value.
	 * Namespace and prefix of the returned attribute are the same as those of
	 * the calling AbstractXLElement-subclass.
	 * 
	 * @param doc
