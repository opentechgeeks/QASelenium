 ...
 * Besides adding child XLElements and setting other features, the Workbook can
 * be used to merge Styles. After finishing the Workbook you'll probably want to
 * create the {@link org.w3c.dom.Document}, the structure that holds this
 * Workbook and all of it's children. This is done with the
 * {@link #createDocument()}-method.
 * <P>
 * A Workbook might also be obtained from an
 * {@link nl.fountain.xelem.lex.ExcelReader}, an object that reads Excel
 * xml-files or xml-InputSources.
 * 
 * 
 * 
 * @see <a
 *      href="../../../../overview-summary.html#overview_description">overview</a>
 */
public interface Workbook extends XLElement {
	 ...
	 * {@link #setFileName(String)} the name of the workbook is returned with
	 * the extension '.xls'.
	 */
	String getFileName();
	 ...
	 * 
	 * @param newID
	 *            the ss:ID of the new merged style
	 * @param id1
	 *            the ss:ID of the copied style
	 * @param id2
	 *            the ss:ID of the appended style
	 * 
	 * @throws UnsupportedStyleException
	 *             if either of the styles mentioned with id1 or id2 are unknown
	 *             to the factory.
	 * 
	...
	/**
	 * Sets whether this Workbook's {@link #createDocument()}-method will print
	 * comments which were set with
	...
	/**
	 * Specifies whether this Workbook's {@link #createDocument()}-method will
	 * include comments.
	 */
	boolean isPrintingElementComments();

	/**
	 * Sets whether this Workbook's {@link #createDocument()}-method will
	 * include docComments. DocComments are the comments that will be passed in
	 * at the start of the Workbook document, just after the processing
	 * instruction.
	 * <P>
	...
	/**
	 * Appends a Worksheet with general information to this Workbook. The
	 * infoSheet is allways displayed as the last worksheet.
	 */
	void appendInfoSheet();

	/**
	 * Set the DocumentProperties of this workbook or, if this workbook allready
	 * had DocumentProperties, replace it.
	 * 
	 * @param docProps
	 *            the DocumentProperties for this workbook
	 */
	 ...
	 * 
	 * @param excelWb
	 *            The ExcelWorkbook for this workbook
	 */
	 ...
	 * <code>[worksheet name]!R1C1:R1C1</code>. If this workbook allready
	 * contained a NamedRange with the given name, replaces it.
	 * 
	 * @param name
	...
	/**
	 * Adds a new NamedRange to this workbook. If this workbook allready
	 * contained a NamedRange with an equal name, replaces it.
	 * 
	 * @param namedRange
	...
	/**
	 * Adds a new Worksheet to this workbook. The new sheet will have the name
	 * "Sheet[x]", where [x] is a sequential number to prevent the duplication
	 * of sheet names. The worksheets cellpointer will be at position row 1,
	 * column 1.
	 * 
	...
	/**
	 * Adds a new Worksheet to this workbook with the given name as name. The
	 * worksheets cellpointer will be at position row 1, column 1.
	 * 
	 * @param name
	 ...
	 *             if a sheet with this name is allready present in this
	 *             workbook.
	 */
	 ...
	 * 
	 * @throws DuplicateNameException
	 *             if a sheet with such a name is allready present in this
	 *             workbook.
	 */
	...
	/**
	 * Gets a list of all the names of worksheets in this workbook in display
	 * order. This list may be used to manipulate the display order of sheets.
	 * For instance:
	 * 
	 * <PRE>
	 ...
	 * 
	 * @return The worksheet with the given name or <code>null</code> if no
	 *         worksheet with that name was in this workbook.
	 */
	 ...
	 * @return the worksheet at the given index or <code>null</code> if no
	 *         worksheet was at that index
	 */
	Worksheet getWorksheetAt(int index);

	/**
	 * Creates a {@link org.w3c.dom.Document}, the structure that holds this
	 * Workbook and all of it's children.
	 * <P>
	 * During assembly non fatal-errors will be registered as warnings. See
	 * {@link #getWarnings()}. A new call to createDocument erases all previous
	 * warnings.
	 * <P>
	 ...
	 * <LI>A cell, column, row or table was given a styleID, but the
	 * corresponding definition of that style was not found in the XFactory. The
	 * workbook will create an empty definition of that style (i.e.
	 * <code>&lt;Style ss:ID="foo"/&gt;</code>).
	 * <LI>The method {@link #appendInfoSheet()} was called, but an
	 * infoSheet-Node could not be created.
	 * </UL>
	 * 
	 * 
	...
	/**
	 * Gets a list of warnings (Strings) that were registered during assembly of
	 * this workbook after a call to {@link #createDocument()}.
	 * 
