...
public interface Worksheet extends XLElement {
	 ...
	 * 
	 * @return <code>true</code> if this worksheet is displayed from right to
	 *         left
	 */
	 ...
	 * <P>
	 * If the workbook has a named range with the same name, the named range on
	 * the worksheet level has precedence over the one defined on the workbook
	 * level.
	 * <P>
	 * The string <code>refersTo</code> should be in R1C1-reference style i.e.
	 * in the format <code>[worksheet name]!R1C1:R1C1</code>. You may skip the
	 * worksheet indicator: <code>R1C1:R1C1</code> will do as well.
	 * 
	 * @param name
	 *            The name to apply to the range.
	 * @param refersTo
	...
	/**
	 * Adds a new NamedRange to this worksheet. If this workbook allready
	 * contained a NamedRange with the same name, replaces that NamedRange.
	 * <P>
	 * If the workbook has a named range with the same name, the named range on
	 * the worksheet level has precedence over the one defined on the workbook
	 * level.
	...
	/**
	 * Sets the given worksheetOptions as the worksheetOptions of this
	 * worksheet.
	 * 
	 * @param wso
	 *            the worksheetOptions to be set on this worksheet
	 */
	 ...
	 * 
	 * @param table
	 *            the table to be set on this worksheet
	 */
	 ...
	 * {@link nl.fountain.xelem.CellPointer} and moves the cellpointer. <br>
	 * If this worksheet did not have a table, a new table will be added.
	 * 
	 * @return A new cell with an initial datatype of "String" and an empty ("")
	 *         value.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the position of the cellpointer is not within the limits
	 *             of the worksheet.
	 * 
	 ...
	 * If this worksheet did not have a table, a new table will be added.
	 * <P>
	 * Datatype and value of the new cell depend on the passed object. The new
	 * cell will have it's styleID set to the given id.
	 * 
	 * @param data
	 *            The data to be displayed in this cell.
	 * @param styleID
	 ...
	 *            The data to be displayed in this cell.
	 * 
	 * @return A new cell with a datatype "Number" and the given double as
	 *         value.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the position of the cellpointer is not within the limits
	 ...
	 * Adds a new cell at the current position of the worksheets
	 * {@link nl.fountain.xelem.CellPointer} and moves the cellpointer. <br>
	 * If this worksheet did not have a table, a new table will be added. The
	 * new cell will have it's styleID set to the given id.
	 * 
	 * @param data
	 *            The data to be displayed in this cell.
	 * @param styleID
	...
	/**
	 * Adds a new cell at the given address. If this worksheet didn't have a row
	 * at the row index of the given address, a new row will be added. If there
	 * was a cell at the given address, replaces this cell. If this worksheet
	 * did not have a table, a new table will be added. <br>
	 * Moves the cellpointer to a new position relative to <code>address</code>.
	 * 
	 * @param address
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the address is not within the limits of the worksheet.
	 * 
	 * @see nl.fountain.xelem.CellPointer#move()
	 */
	 ...
	 * replaces this cell. If this worksheet did not have a table, a new table
	 * will be added. <br>
	 * Moves the cellpointer to a new position relative to <code>rowIndex</code>
	 * and <code>columnIndex</code>.
	 * 
	 * @param rowIndex
	 *            The row index (row number).
	 * @param columnIndex
	 ...
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if the position is not within the limits of the worksheet.
	 * 
	 * @see nl.fountain.xelem.CellPointer#move()
	 */
	...
	/**
	 * Adds a new cell at the address specified by the A1-reference string. If
	 * this worksheet didn't have a row at the row index specified, a new row
	 * will be added. If the place at the given coordinates was allredy occupied
	 * by another cell, replaces this cell. If this worksheet did not have a
	 * table, a new table will be added. <br>
	 * Moves the cellpointer to a new position relative to the address specified
	 * by the A1-reference string.
	 * 
	 * @param a1_ref
	...
	/**
	 * Adds the given cell at the given address. If this worksheet didn't have a
	 * row at the row index of the given address, a new row will be added. If
	 * there was a cell at the given address, replaces this cell. If this
	 * worksheet did not have a table, a new table will be added. <br>
	 * Moves the cellpointer to a new position relative to <code>address</code>.
	 * 
	 * @param address
	 *            The address where the cell should be added.
	 * @param cell
	 ...
	 * If this worksheet didn't have a row at the index specified, a new row
	 * will be added. If the place at the given coordinates was allredy occupied
	 * by another cell, replaces this cell. If this worksheet did not have a
	 * table, a new table will be added. <br>
	 * Moves the cellpointer to a new position relative to the address specified
	...
	/**
	 * Gets the cell at address specified by the given string in A1-reference
	 * style.
	 * 
	 * @param a1_ref
	 *            a string of A1-reference style
	...
	/**
	 * Specifies whether there is a cell at the intersection of the given row
	 * and column index.
	 */
	boolean hasCellAt(int rowIndex, int columnIndex);

	/**
	 * Specifies whether there is a cell at the address specified by the given
	 * string in A1-reference style.
	 */
	boolean hasCellAt(String a1_ref);

	/**
	 * Adds a new Row to this worksheet. If no rows were previously added the
	 * row will be added at index 1. Otherwise the row will be added at
	 * {@link nl.fountain.xelem.excel.Table#maxRowIndex() maxRowIndex} of the
	 * underlying Table + 1.
	 * 
	 * @return A new Row.
	 * @throws IndexOutOfBoundsException
	 *             If the calculated index is less then {@link #firstRow} or
	 *             greater then {@link #lastRow}.
	 */
	Row addRow();

	/**
	 * Adds a new Row at the given index to this worksheet. If the index was
	 * allready occupied by another row, replaces this row.
	 * 
	 * @param index
	 *            The index (row number) of the row.
	 * @return A new Row.
	 * @throws IndexOutOfBoundsException
	 *             If the given index is less then {@link #firstRow} or greater
	 *             then {@link #lastRow}.
	 */
	...
	/**
	 * Adds the given Row at the given index to this worksheet. If the index was
	 * allready occupied by another row, replaces this row.
	 * 
	 * @param index
	 *            The index (row number) of the row.
	 ...
	 *            The index (row number) of the row.
	 * 
	 * @return The removed row or <code>null</code> if the index was not
	 *         occupied by a row.
	 */
	 ...
	 * at {@link nl.fountain.xelem.excel.Table#maxColumnIndex() maxColumnIndex}
	 * of the underlying Table + 1.
	 * 
	 * @return A new column.
	 * @throws IndexOutOfBoundsException
	 *             If the calculated index is less then {@link #firstColumn} or
	 *             greater then {@link #lastColumn}.
	 */
	Column addColumn();

	/**
	 * Adds a new Column at the given index to this worksheet. If the index was
	 * allready occupied by another column, replaces this column.
	 * 
	 * @param index
	 *            The index (column number) of the column.
	 * @return A new column.
	 * @throws IndexOutOfBoundsException
	 *             If the given index is less then {@link #firstColumn} or
	 *             greater then {@link #lastColumn}.
	 */
	Column addColumnAt(int index);

	/**
	 * Adds a new Column at the index specified by the given label. If the index
	 * was allready occupied by another column, replaces this column.
	 * 
	 * @param label
	 *            a string ("A" through "IV" inclusive) corresponding to the
	 *            column index
	 * @return A new column.
	 * @throws IndexOutOfBoundsException
	 *             If the given index is less then {@link #firstColumn} or
	...
	/**
	 * Adds the given column to this worksheet. If no columns were previously
	 * added the column will be added at index 1. Otherwise the ccolumn will be
	 * added at {@link nl.fountain.xelem.excel.Table#maxColumnIndex()
	 * maxColumnIndex} of the underlying Table + 1.
	 * 
	 * @param column
	...
	/**
	 * Adds the given Column at the given index specified by the given label. If
	 * the index was allready occupied by another column, replaces this column.
	 * 
	 * @param label
	 *            a string ("A" through "IV" inclusive) corresponding to the
	 *            column index
	 ...
	 *            The index (column number) of the column.
	 * 
	 * @return The removed column or <code>null</code> if the index was not
	 *         occupied by a column.
	 */
	...
	/**
	 * Gets the column at the index specified by the given label. If no column
	 * was at the index, returns a new column.
	 * 
	 * @param label
	 *            a string ("A" through "IV" inclusive) corresponding to the
	 *            column index
	...
	/**
	 * Specifies whether there is a column at the index specified by the given
	 * label.
	 * 
	 * @param label
	 *            a string ("A" through "IV" inclusive) corresponding to the
	 ...
	 * <P>
	 * The String <code>rcString</code> should include all of the columns that
	 * are to be equiped with a drop-down button at their column- headings, and
	 * should either include just the row of the column-headings or the entire
	 * range on which the AutoFilter must be set.
	 * <P>
	 * Here are some examples: <br>
	 * Given a table of 3 columns and 11 rows. The column-headings are at row
	 * 10. The table-data expands to row 21.
	 * <UL>
	 * <LI><code><b>R10C1:R10C3</b></code> - the AutoFilter includes the entire
	 * range (R10C1:R21C3) and will dynamically expand if more rows of data are
	 * added below.
	 * <LI><code><b>R10C1:R21C3</b></code> - the AutoFilter includes the entire
	 * range (R10C1:R21C3) and will dynamically expand if more rows of data are
	 * added below.
	 * <LI><code><b>R10C1:R10C2</b></code> - the AutoFilter includes the entire
	 * range (R10C1:R21C3) and will dynamically expand if more rows of data are
	 * added below, however, only the first two column-headings have drop -down
	 * buttons.
	 * <LI><code><b>R12C1:R12C3</b></code> - drop-down buttons manifest at row
	 * 12; this is probably not what you wanted.
	 * </UL>
	 * 
	 * @param rcString
	 *            A String of R1C1 reference style.
	 ...
	 * 
	 * @param af
	 *            the AutoFilter to be set on this worksheet.
	 */
