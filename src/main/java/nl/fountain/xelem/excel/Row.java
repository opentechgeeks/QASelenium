 ...
 * nor of it's index-position in a table or worksheet. This makes it possible to
 * use the same instances of Rows on different worksheets, or different places
 * in the worksheet. Only at the time of assembly the row-index and the
 * attribute ss:Index are automatically set, if necessary. See also:
 * {@link nl.fountain.xelem.excel.Table#rowIterator()}. (Also a Row that is read
...
public interface Row extends XLElement {
	...
	/**
	 * Sets the ss:StyleID on this row. If no styleID is set on a row, the
	 * ss:StyleID-attribute is not deployed in the resulting xml and Excel
	 * employes the Default-style on the row.
	 * 
	 * @param id
	 *            the id of the style to employ on this row.
	 */
	 ...
	 * 
	 * @return The id of the style to employ on this row or <code>null</code> if
	 *         no styleID was previously set.
	 */
	String getStyleID();

	/**
	 * Sets the span of this row. The value of <code>s</code> must be greater
	 * than 0 in order to have effect on the resulting xml.
	 * <P>
	 ...
	 * 
	 * @param s
	 *            The number of additional rows to include in the span.
	 */
	void setSpan(int s);
	...
	/**
	 * Gets the height of this row. A return value of <code>0.0</code> may
	 * indicate this row has a default height.
	 * 
	 ...
	 * 
	 * @param hide
	 *            <code>true</code> if this row must not be displayed.
	 */
	...
	/**
	 * Adds a new Cell to this row. If no cells were previously added the cell
	 * will be added at index 1. Otherwise the cell will be added at
	 * {@link #maxCellIndex()} + 1.
	 * 
	 ...
	 *             {@link nl.fountain.xelem.excel.Worksheet#firstColumn} or
	 *             greater then
	 ...
	 * Adds a new Cell to this row. If no cells were previously added the cell
	 * will be added at index 1. Otherwise the cell will be added at
	 * {@link #maxCellIndex()} + 1. The new cell will have it's styleID set to
	 * the given id.
	 * 
	 * @param data
	 *            The data to be displayed in this cell.
	...
	/**
	 * Adds the given Cell to this row. If no cells were previously added the
	 * cell will be added at index 1. Otherwise the cell will be added at
	 * {@link #maxCellIndex()} + 1.
	 * 
	 * @param cell
	...
	/**
	 * Adds a new Cell at the given index. If the index was allready occupied by
	 * another cell, replaces this cell.
	 * 
	 * @param index
	...
	/**
	 * Adds the given Cell at the given index. If the index was allready
	 * occupied by another cell, replaces this cell.
	 * 
	 * @param index
	 *            The index (column number) of the cell.
	 * @param cell
	 ...
	 *            The index (column number) of the cell.
	 * 
	 * @return The removed cell or <code>null</code> if the index was not
	 *         occupied by a cell.
	 */
	 ...
	 * <code>doc</code> as owner-document. The attribute <code>span</code> will
	 * not be reflected in this Element.
	 * 
	 * @param doc
	 *            the {@link org.w3c.dom.Document} to which this row will be
	 *            appended.
	...
	/**
	 * Sets the value of the ss:Index-attribute of this Row-element. Any value
	 * set may be overruled by
	 * {@link nl.fountain.xelem.excel.Table#rowIterator()}, which sets the index
	 * of rows during assembly.
	 * <P>
	 * <em>
	...
	/**
	 * Gets the value of the ss:Index-attribute of this Row-element. The
	 * returned value only makes sence if this row was read with the reader-API
	 * in the nl.fountain.xelem.lex-package and before any manipulation of this
	 * row or the workbook took place.
	 * 
