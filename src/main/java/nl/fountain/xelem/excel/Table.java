...
public interface Table extends XLElement {
	...
	/**
	 * Sets the ss:StyleID on this table. If no styleID is set on a table, the
	 * ss:StyleID-attribute is not deployed in the resulting xml and Excel
	 * employes the Default-style on the table.
	 * 
	 * @param id
	 *            the id of the style to employ on this table.
	 */
	 ...
	 * 
	 * @return The id of the style to employ on this table or <code>null</code>
	...
	/**
	 * Adds a new Column to this table. If no columns were previously added the
	 * column will be added at index 1. Otherwise the column will be added at
	 * {@link #maxColumnIndex()} + 1.
	 * 
	 * @return A new column.
	...
	/**
	 * Adds a new Column at the given index to this table. If the index was
	...
	/**
	 * Adds the given Column at the given index to this table. If the index was
	 * allready occupied by another column, replaces this column.
	 * 
	 * @param index
	 *            The index (column number) of the column.
	...
	/**
	 * Returns an iterator for the columns in this table. Columns are aware of
	 * their index number when passed by this iterator.
	 * 
	...
	/**
	 * Adds a new Row to this table. If no rows were previously added the row
	 * will be added at index 1. Otherwise the row will be added at
	 * {@link #maxRowIndex()} + 1.
	 * 
	 * @return A new Row.
	 * @throws IndexOutOfBoundsException
	...
	/**
	 * Adds a new Row at the given index to this table. If the index was
	...
	/**
	 * Adds the given row to this table. If no rows were previously added the
	...
	/**
	 * Adds the given Row at the given index to this table. If the index was
	 * allready occupied by another row, replaces this row.
	 * 
	 * @param index
	 *            The index (row number) of the row.
	...
	/**
	 * Gets the highest index number of all the cells of all the rows in this
	 * table: the right-most cell.
	 * 
	...
	/**
	 * An indicator of the index of the right-most column on this table. May
	 * have been set when reading workbooks.
	 * 
	...
	/**
	 * An indicator of the index of the bottom row on this table. May have been
	 * set when reading workbooks.
	 * 
