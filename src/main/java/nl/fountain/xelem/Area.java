...
public class Area {
	 ...
	 * 
	 * @param address1
	 *            the address in one corner of the area
	 * @param address2
	...
	/**
	 * Constructs a new Area. This constructor takes an A1-reference string as a
	 * parameter. For instance "B4:E6" will construct an area delimmited by rows
	 * 4 and 6 and columns 2 and 5. Treats the passed string case-insensitive.
	 * <P>
	 * Splits the string in the parameter on ":" and calculates row and column
	 * numbers with the 2 resulting strings.
	 * 
	 * @param a1_ref
	 *            a string of A1-reference style
	 * @throws IllegalArgumentException
	 *             if a1_ref cannot be split in two strings using ":" as
	 *             breakpoint.
	...
	public Area(String a1_ref) {
		...
		setDimensions(Address.calculateRow(ar[0]),
				Address.calculateColumn(ar[0]), Address.calculateRow(ar[1]),
	...
	/**
	 * Specifies whether the intersection of the given row and column index is
	 * within this area.
	 * 
	 * @param rowIndex
	 *            the rownumber
	...
	public boolean isWithinArea(int rowIndex, int columnIndex) {
		return rowIndex >= r1 && rowIndex <= r2 && columnIndex >= c1
				&& columnIndex <= c2;
	}
